...
if __name__ == "__main__":
  ...
  test_basic_info = pd.read_json("/teamspace/studios/this_studio/travail/CodeFuse-CGM/rewriter/test_rewriter_output.json")
  ...
  for idx, item in test_basic_info.iterrows():
    ...
    with open("/teamspace/studios/this_studio/travail/CodeFuse-CGM/rewriter/rewriter_output.json", 'w', encoding='utf-8') as file:
        json.dump(rewriter_output_dict, file)
  
  # save trajs
  test_basic_info.to_json("/teamspace/studios/this_studio/travail/CodeFuse-CGM/rewriter/test_rewriter_output.json", index=False)
