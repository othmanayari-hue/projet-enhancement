...
if __name__ == "__main__":
  ...
  test_basic_info = pd.read_json(
    "/teamspace/studios/this_studio/travail/CodeFuse-CGM/preprocess_embedding/test_lite_basic_info.json",
    orient="index"
)
  ...
  test_basic_info.to_json("/teamspace/studios/this_studio/travail/CodeFuse-CGM/rewriter/test_rewriter_prompt.json", index=False)
print("done")